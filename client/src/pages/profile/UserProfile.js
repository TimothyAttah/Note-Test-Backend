...
const UserProfile = () => {
	...
	const [showFollow, setShowFollow] = useState(
		user && user.results ? !user.results.following.includes(id) : true
	);

	const fullName = `${userProfile && userProfile.user.firstName} ${
									...
									<ProfilePost>
										...
										<ProfilePostButton>
											<Button variant='contained' size='small' color='primary'>
												<Link to={`/api/users/notes/${note._id}/note/read`}>
													Read More
												</Link>
											</Button>
										</ProfilePostButton>
