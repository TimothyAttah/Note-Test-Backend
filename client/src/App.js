		...
		<MainContainer>
			<Router history={history}>
				...
				<Switch>
					...
					<Route
						path='/api/auth/users/:id/user/profile'
						exact
						component={UserProfile}
					/>
					<Route path='/api/users/notes' exact component={Notes} />
					<Route
						path='/api/users/notes/:noteId/note/delete'
						component={NotesDelete}
					/>
					<Route
						path='/api/users/notes/:noteId/note/edit'
						component={NotesEdit}
					/>
					<Route path='/api/users/notes/create/note' component={NotesCreate} />
					<Route
						path='/api/users/notes/:noteId/note/read'
						component={NotesRead}
					/>
					<Route path='/api/users/todos' exact component={Todos} />
					<Route
						path='/api/users/todos/:todosId/edit'
						exact
						component={Todos}
					/>
