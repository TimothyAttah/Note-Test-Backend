...
export const notesEdit = (noteId, notesData) =>
	API.put(`notes/${noteId}/edit`, notesData);
...
export const deleteIncome = incomeId =>
	API.delete(`incomes/${incomeId}/delete`);

export const getExpenses = () => API.get('/expenses/user/expenses');

export const createExpenses = expensesData =>
	API.post('/expenses/add', expensesData);

export const deleteExpenses = expensesId =>
	API.delete(`expenses/${expensesId}/delete`);
...
export const editTodos = (todosData, todosId) =>
	API.put(`/todos/${todosId}/edit`, todosData);

export const checkTodos = (todosData, todosId) =>
	API.patch(`/todos/${todosId}/edit`, todosData);

export const uploadAvatar = avatarData =>
	API.post('/upload/upload_avatar', avatarData);

export const getAllUploadsAvatars = () => API.get(`/upload/all_uploads`);
